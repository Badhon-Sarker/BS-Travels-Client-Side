...
const PlaceCard = ({ place }) => {
  ...
  return (
    <div data-aos="fade-up" data-aos-duration="1100"  className="p-1">
        ...
        <div className="card-body pt-2 font-playfair">
          ...
          <div className="flex flex-col justify-center items-center gap-1">
            <div className="flex justify-between gap-4">
              <div >
                <h1 data-aos="fade-right" data-aos-duration="1200" className="font-semibold">
                  Season: <span className="text-gray-600">{seasonality}</span>{" "}
                </h1>
              </div>

              <div>
                <h1 data-aos="fade-left" data-aos-duration="1200" className="font-semibold">Cost: {cost} $</h1>
              </div>
            </div>

            <div>
              <h1 data-aos="fade-up" data-aos-duration="1300" className="font-semibold">
                Visitors: <span className="text-gray-600">{visitors} /Y</span>
              </h1>
            </div>

            <div>
              <h1 data-aos="fade-down" data-aos-duration="1300" className="font-semibold">
                Travel Time: <span className="text-gray-600">{time}</span>
              </h1>
            </div>
          ...
          <div className="card-actions justify-center">
            ...
            <Link data-aos="zoom-in" data-aos-duration="1200" to={`/details/${place._id}`}><button className="btn">View Details</button></Link>
          </div>
        </div>
      </div>
    </div>
